...
| Sensor Unit |	Physical unit associated with sensor values (Either ‘ADC’, ‘degrees C’, ‘m’ or ‘m/s2’) | Yes |
...
| sensor_unit |	Physical unit associated with sensor values (Either ‘ADC’, ‘degrees C’, ‘m’ or ‘m/s2’) | Yes |
...
| sensor_unit |	Physical unit associated with sensor values (Either ‘ADC’, ‘degrees C’, ‘m’ or ‘m/s2’) | No |
